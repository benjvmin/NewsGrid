  ...
  const Menu = {
    ...
    changeTheme(e) {
      ...
      if (color === undefined) {
        ...
        this.elements.root.style.setProperty("--linear-gradient", `linear-gradient(to bottom, var(--color-one), var(--${color}))`);
      }
    },
    ...
    materialClick(e) {
      ...
      console.log((e.clientX - left), (e.clientY - top), top, left);
    }
  };
